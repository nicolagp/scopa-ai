...
def main():
    ...
    def run_game(n_players: int):
        ...
        while True:
            ...
            for i in range(3):
                # 2 computers
                if isinstance(scopa.players[0], Computer) and isinstance(scopa.players[0], Computer):
                    for player in (first, second):
                        ...
                        print(scopa)
                # 1 player, 1 computer
                elif (isinstance(scopa.players[0], Computer) and not isinstance(scopa.players[1], Computer)) or (
                        not (isinstance(scopa.players[0], Computer) or not isinstance(scopa.players[1], Computer))):
                    for player in (first, second):
